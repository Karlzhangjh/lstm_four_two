...
def load_data(filename):
	...
	plt.title('from 20s to predict 0.8 0.9 1.1 1.3 1.5 1.7 1.9 by lstm')
	...
	plt.plot(lstm_1[:,1],label='lstm_8')
	plt.plot(lstm_3[:,1],label='lstm_9')
	plt.plot(lstm_5[:,1],label='lstm_11')
	plt.plot(lstm_6[:,1],label='lstm_13')
	plt.plot(lstm_7[:,1],label='lstm_15')
	plt.plot(lstm_8[:,1],label='lstm_17')
	plt.plot(lstm_9[:,1],label='lstm_19')
...
if __name__ == '__main__':
	...
	load_data('20_8_9_11_13_15_17_19.csv')
